 ...
 * 10. ★ aplicarDescuento — función de descuento por volumen (NUEVA)
 */
...
function createStepper(config) {
  ...
  // DELEGACIÓN DE EVENTOS en el contenedor del flujo.
...
createStepper({
  ...
  validators: {
    // Validadores del flujo de postulación.
    1: () => {
      const e = [];
...
// ---- FLOW TABS ----
// Maneja los tabs que alternan entre el flujo cliente y el flujo postulante.
...
// ============================================================
// HELPERS — Funciones utilitarias reutilizadas en todo el archivo
// ============================================================
function v(id) {
...
// ════════════════════════════════════════════════════════════
// ★ 10. FUNCIÓN NUEVA: aplicarDescuento(total)
//
// DÓNDE VIVE EN EL ARCHIVO: al final, antes del cierre.
// Está fuera de cualquier IIFE para ser accesible globalmente.
//
...
/**
 * Calcula el precio final aplicando descuento por monto de compra.
 *
...
// Requiere agregar en el HTML el bloque <div id="calculadora-tela"> (ver index.html).
(function initCalculadoraTela() {
  ...
  function calcularYMostrar() {
    ...
    // Lee cuántos metros ingresó el usuario.
